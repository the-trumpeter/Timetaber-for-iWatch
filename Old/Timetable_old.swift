...
let monA: Dictionary<Int, DisplayCourse> = [
...
let tueA: Dictionary<Int, DisplayCourse> = [
    0900: CheckInCourse, 0910: VisualArtsCourse, 1010: PACourseC1,
    1110: RecessPeriod, 1130: PDHPE1, 1230: English9,
    1330: LunchPeriod, 1410: MathsCourse,
    1510: SSBCourse, 1700: noSchool(.afterClass)
]

let wedA: Dictionary<Int, DisplayCourse> = [
    0900: TAS, 1050: yearAssembly,
    1100: RecessPeriod, 1120: ScienceCourse, 1210: MathsCourse,
    1300: LunchPeriod, 1330: TCCourse,
    1510: MSBCourse, 1730: noSchool(.afterClass)
]

let thuA: Dictionary<Int, DisplayCourse> = [
    0900: CheckInCourse, 0910: ScienceCourse, 1010: MultimediaCourse,
    1110: RecessPeriod, 1130: HSIECourse, 1230: English6,
    1330: LunchPeriod, 1410: JCBCourse,
    1530: GreaseOrchCourse, 1700: noSchool(.afterClass)
]

let friA: Dictionary<Int, DisplayCourse> = [
...
let monB: Dictionary<Int, DisplayCourse> = [
...
let friB: Dictionary<Int, DisplayCourse> = [
